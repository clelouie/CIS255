 ...
 * 
 * Given a zipcode from input, retrieves associated state abbreviation, then state name.
 * Using the state name, outputs state and associated population.
 */
   ...
   public static void main(String[] args) throws IOException {
      ...
      for (i = 0; i < zipCodeState.size(); ++i) {
         // TODO: Using ZIP code, find state abbreviation
    	  if (zipCodeState.get(i).getValue1() == myZipCode) {
    		  stateAbbrev = zipCodeState.get(i).getValue2();
    	  }
      }
      ...
      for (i = 0; i < abbrevState.size(); ++i) {
         // TODO: Using state abbreviation, find state name
    	  if (abbrevState.get(i).getValue1().equals(stateAbbrev)) {
